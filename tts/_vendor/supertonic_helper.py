...
# [supertonic3-tts 수정] 원본은 ["en", "ko", "es", "pt", "fr"] — Supertonic 2의
# 5개 언어 목록이 Supertonic 3로 오면서 갱신되지 않은 채 남아 있었다.
# _preprocess_text가 이 목록에 없는 언어를 ValueError로 거부하기 때문에,
# ja/de/ru 등 나머지 26개 언어와 언어 무관 모드 "na"가 통째로 막혀 있었다.
# 모델카드(https://huggingface.co/Supertone/supertonic-3) "Supported Languages"
# 표의 31개 언어 + README가 안내하는 lang="na" 를 모두 연다.
AVAILABLE_LANGS = [
